...
import io.vertx.blueprint.todolist.ConstantsBlocking;
 ...
 * @author orange
 */
public class TodoBlockingVerticle extends AbstractVerticle {

  private static final Logger LOGGER = LoggerFactory.getLogger(TodoBlockingVerticle.class);
  ...
  public void start(Future<Void> future) throws Exception {
    ...
    // routes
    router.get(ConstantsBlocking.API_GET).blockingHandler(this::handleGetTodo);
    router.get(ConstantsBlocking.API_LIST_ALL).blockingHandler(this::handleGetAll);
    router.post(ConstantsBlocking.API_CREATE).blockingHandler(this::handleCreateTodo);
    router.patch(ConstantsBlocking.API_UPDATE).blockingHandler(this::handleUpdateTodo);
    router.delete(ConstantsBlocking.API_DELETE).blockingHandler(this::handleDeleteOne);
    router.delete(ConstantsBlocking.API_DELETE_ALL).blockingHandler(this::handleDeleteAll);
